...
LOAD CSV with headers FROM "file:///AdventureWorksDep.csv" as row
...
SET f.url = 'http://localhost:8000/AW/pc-cas_dev/User_databases/AdventureWorks/Programmability/Functions/Table-valued_Functions/'
...
SET f.url = 'http://localhost:8000/AW/pc-cas_dev/User_databases/AdventureWorks/Tables/'
+ replace(split(row._SqlServerInstance_Database_Object_Name,'.[')[1],']','')
+ '.html';

//http://localhost:8000/AW/pc-cas_dev/User_databases/AdventureWorks/Tables/Address.html
...
SET f.url = 'http://localhost:8000/AW/pc-cas_dev/User_databases/AdventureWorks/Programmability/Stored_Procedures/'
+ replace(split(row._SqlServerInstance_Database_Object_Name,'.[')[1],']','')
+ '.html';
...
SET f.url = 'http://localhost:8000/AW/pc-cas_dev/User_databases/AdventureWorks/Views/'
+ replace(split(row._SqlServerInstance_Database_Object_Name,'.[')[1],']','')
+ '.html';
